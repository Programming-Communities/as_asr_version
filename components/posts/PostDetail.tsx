...
import { Bookmark, Clock, User, Calendar, Eye, Play } from 'lucide-react';
...
export default function PostDetail({ post }: PostDetailProps) {
  ...
  return (
    <article className="max-w-4xl mx-auto">
      ...
      {/* Video section */}
      // Add this to the component after featured image section:
...
{post.acf?.video_url && (
  <div className="mb-8">
    <div className="relative w-full h-96 rounded-2xl overflow-hidden bg-black">
      ...
      {/* Featured image (only if no video or as fallback) */}
      {!showVideo && post.featuredImage && (
